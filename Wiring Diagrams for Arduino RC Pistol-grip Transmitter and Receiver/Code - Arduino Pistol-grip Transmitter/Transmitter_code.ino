/*A basic 8 channel transmitter using the nRF24L01 module - code originally by Electronoobs.
 Code modified by Max Imagination for the Arduino-based Pistol-grip transmitter.
